...
public class TaskController {
    ...
    @PostMapping("/create")
    public String createTask(@RequestParam("nameTask") String nameTask, @RequestParam("taskBody") String taskBody, @RequestParam("status") String status, @RequestParam("user") long userId) {

        taskService.createTask(nameTask, taskBody, status, userId);
